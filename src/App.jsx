    ...
    <>
      <nav className="navbar fixed top-0 left-0 w-full bg-none bg-opacity-90 p-4 flex flex-col sm:flex-row items-center justify-between z-50">
        <div className="flex flex-col items-center mb-4 sm:mb-0">
          ...
          <h1 className="text-white text-xl sm:text-2xl font-alfaSlabOne">XYLE</h1>
        </div>
        <div className="flex flex-wrap justify-center items-center text-white underline hover:text-gray-300 font-helvetica space-x-4 sm:space-x-8">
          <a href="#home" className="mb-2 sm:mb-0">Home</a>
          <a href="#brands" className="mb-2 sm:mb-0">Our Brands</a>
          <a href="#functions" className="mb-2 sm:mb-0">Our Functions</a>
          <a href="#contact" className="mb-2 sm:mb-0">Contact Us</a>
        </div>
      </nav>

      <div id="home" className="div-1 relative bg-cover bg-center min-h-screen w-full flex items-center justify-center px-4 sm:px-8">
        <div className="text-center text-white">
          <span data-aos="fade-up" className="block font-georgia text-4xl sm:text-6xl md:text-7xl lg:text-9xl">
            Connecting Dots
          </span>
          <span data-aos="fade-up" data-aos-delay="50" className="block font-judson text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
            Between
          </span>
          <span data-aos="fade-up" data-aos-delay="100" className="block text-[#31A2C4] font-georgia text-4xl sm:text-6xl md:text-7xl lg:text-9xl -mt-2">
            Brands
          </span>
          <span data-aos="fade-up" data-aos-delay="150" className="block font-judson text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
            And
          </span>
          <span data-aos="fade-up" data-aos-delay="200" className="block text-[#31A2C4] font-georgia text-4xl sm:text-6xl md:text-7xl lg:text-9xl -mt-2">
            Audience
          </span>
        </div>
      </div>
      ...
      <div className="div-2 overflow-x-clip relative bg-cover bg-center w-full min-h-screen flex flex-col lg:flex-row gap-8 lg:gap-x-40 justify-center items-center px-4 sm:px-8 py-12">
        <div className="div-2-1 w-full lg:w-[40%] text-white font-helveticaLight text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl bigger-line-height" data-aos="fade-right">
        ...
        <div className="div-2-2 w-full lg:w-[38%] flex flex-col">
          <div className="flex flex-col h-2/5">
            <div className="flex w-full h-full">
              <img data-aos="fade-left" src={div_2_1_img} className="w-3/5" alt="Image 1" />
              <img data-aos="fade-left" data-aos-delay="150" src={div_2_2_img} className="w-2/5" alt="Image 2" />
            </div>
          </div>
      ...
      <div className="div-4 relative bg-cover bg-center min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-8">
        <div className="text-center font-georgia text-white font-arial text-4xl sm:text-6xl lg:text-8xl mx-4 sm:mx-8 lg:mx-40 my-10 sm:my-20">
          <span className="block font-extralight text-5xl sm:text-7xl lg:text-9xl">Some Key</span>
          <span className="block font-extralight text-5xl sm:text-7xl lg:text-9xl">Achievements</span>
        </div>
            ...
            <div className="relative flex justify-center text-center text-white px-4 sm:px-16 py-3 w-full">
              ...
              <div className="relative flex flex-col sm:flex-row justify-between text-center text-white px-4 sm:px-16 py-2 w-full max-w-7xl gap-8 sm:gap-4">
                <div className="px-2 sm:px-4">
                  <span className="block font-georgia font-bold text-4xl sm:text-5xl lg:text-7xl p-2">150+</span>
                  <span className="block font-helvetica text-lg sm:text-xl lg:text-3xl">Clients</span>
                </div>
                <div className="px-2 sm:px-4">
                  <span className="block font-georgia font-bold text-4xl sm:text-5xl lg:text-7xl p-2">320+</span>
                  <span className="block font-helvetica text-lg sm:text-xl lg:text-3xl">Websites/Apps</span>
                </div>
                <div className="px-2 sm:px-4">
                  <span className="block font-georgia font-bold text-4xl sm:text-5xl lg:text-7xl p-2">95%</span>
                  <span className="block font-helvetica text-lg sm:text-xl lg:text-3xl">Customer Retention</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div id="functions" className="div-5 bg-cover bg-center w-full min-h-screen flex flex-col items-center justify-center space-y-10 py-12 sm:py-24 px-4 sm:px-8">
        <h2 data-aos="fade-down" className="text-center text-white font-georgia text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl mx-4 sm:mx-8 md:mx-16 lg:mx-40">
          Our Functions
        </h2>
        <div className="w-full sm:w-[80%] md:w-[70%] lg:w-[60%] px-4 flex justify-center">
          <img src={div_5_1_img} data-aos="fade-up" alt="Our Functions" className="w-full sm:w-[90%] md:w-[80%] h-auto" />
        </div>
      </div>
      ...
      <div className="relative overflow-x-clip flex flex-col items-center justify-center py-12 sm:py-24">
        <img src={div_7_img} alt="background" className="absolute w-full h-full top-0 left-0 z-0 object-cover" />
        <Swiper
          effect={"coverflow"}
          grabCursor={true}
          centeredSlides={true}
              ...
              >
                ...
                <div className="w-full flex justify-end mt-2">
                  <div className="text-base sm:text-xl">
                    <p className="text-white text-lg sm:text-2xl">{item.author}</p>
      ...
      <div className="div-8 relative bg-cover bg-center min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-8">
        ...
        <div className="w-full sm:w-3/4 flex flex-col gap-y-8 items-center justify-center border-t-2 border-opacity-10 border-white mt-8 sm:mt-24">
          <div className="w-full flex flex-wrap items-center justify-center sm:justify-between px-4 sm:px-12 md:px-24 gap-8">
            <img src="/google.png" className="w-24 sm:w-28 md:w-36" alt="Google" />
            <img src="/amazon.png" className="w-24 sm:w-28 md:w-36" alt="Amazon" />
          ...
          <div className="w-full flex flex-wrap items-center justify-center sm:justify-between px-4 sm:px-12 md:px-24 gap-8">
            ...
            <img src="/indexexchange.png" className="w-24 sm:w-28 md:w-36" alt="Index Exchange" />
      ...
      <div id="contact" className="div-9 relative bg-cover bg-center w-full flex flex-col lg:flex-row justify-center items-center p-8 lg:p-24 xl:p-48">
      ...
      <div className="footer font-gotham bg-cover bg-center text-[#ffffff] pt-24 lg:pt-48 pb-16 lg:pb-36 flex justify-center">
        <div data-aos="fade-up" className="flex flex-col sm:flex-row text-center w-full px-4 sm:px-8">
          ...
          <div className="w-full sm:w-1/3 mb-8 sm:mb-0">
            ...
            <a target="_blank" href="https://monetiseup.com/" rel="noopener noreferrer">
